...
# Exercise-2 TODOs:
    ...
    ros_cloud_table =  pcl_to_ros(cloud_table) #cloud_table
...
# Exercise-3 TODOs: 
    ...
    for index, pts_list in enumerate(cluster_indices):
        ...
        pcl_cluster = cloud_objects.extract(pts_list) ###Dont USE cluster_cloud, the colored object will affect result
